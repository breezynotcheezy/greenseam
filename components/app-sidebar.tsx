            ...
            <SidebarMenu className="space-y-3">
              {menuItems.map((item) => (
                <SidebarMenuItem key={item.title}>
                  <Link href={item.url} className="flex items-center gap-4 p-4 rounded-xl hover:bg-gray-50 data-[active=true]:bg-forest-50 data-[active=true]:text-forest-700 data-[active=true]:border-forest-200 data-[active=true]:border">
